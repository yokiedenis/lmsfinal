...
import { redirect } from "next/navigation";
import Link from "next/link";
import { ArrowLeft, File, LayoutDashboard, Video, ExternalLink } from "lucide-react";
...
import { LiveSessionAttachmentForm } from "./_components/live-session-attachment-form";
import { LiveSessionQuizForm } from "./_components/live-session-quiz-form";
import { LiveSessionGoogleFormQuizForm } from "./_components/live-session-google-form-quiz-form";
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center gap-x-3 mb-6">
                <div className="bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300 rounded-full p-2">
