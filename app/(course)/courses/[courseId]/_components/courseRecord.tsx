  ...
  if (!hasPurchased) {
    return (
      <motion.div
        ...
        style={{ backgroundImage: "url('/bbbckgrd.jpg')" }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <h2 className="text-4xl font-bold mb-4 text-red-500 drop-shadow-lg">Access Denied</h2>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <section className="mb-12">
        ...
        {recordings.length === 0 ? (
          <p className="text-gray-600">No recordings available for this course.</p>
        ) : (
      ...
      <section>
        ...
        {attachments.length === 0 ? (
          <p className="text-gray-600">No attachments available for this course.</p>
        ) : (
