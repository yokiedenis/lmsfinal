...
test('export', function (t /** @type {Test} */) {
...
test('assert', function (t /** @type {Test} */) {
    var channel = getSideChannel();
    t.throws(
